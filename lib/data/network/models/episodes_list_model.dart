...
EpisodesListModel episodesListModelFromJson(String str) => EpisodesListModel.fromJson(json.decode(str));

String episodesListModelToJson(EpisodesListModel data) => json.encode(data.toJson());
